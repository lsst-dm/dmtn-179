...
\(\overline{\hat{P}_r}\hat{P}_r/\abs{\hat{P}_r}^2 = 1\), we can reduce
or expand this factor in the difference image and its PSF terms
without changing their resulting product, the score image.
%
